...
This repository contains the output of [bioCADDIE WG3 Metadata Specifications](https://biocaddie.org/group/working-group/working-group-3-descriptive-metadata-datasets). 
