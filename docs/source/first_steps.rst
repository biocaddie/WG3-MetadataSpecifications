...
DATS records the *Person* (s) and *Organization* (s) associated with the dataset, and supports documenting their roles (e.g. creator, curator, developer, funder, principal investigator).
